...
public class LoadSplashScreen : MonoBehaviour
{
    ...
    public int levelToLoad = 1; // this has to correspond to a level (file>build settings)
    public Texture2D splashLogo; // the logo to splash;
    public float fadeSpeed;
    public float waitTime; // seconds to wait before fading out
    ...
    {
    	//soundThing.AddComponent(AudioSource);
		if(playSound) {
