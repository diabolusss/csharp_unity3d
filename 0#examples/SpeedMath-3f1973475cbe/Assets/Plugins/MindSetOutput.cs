...
public class MindSetOutput : IBrainwaveDataPlayer {
  ...
  public ThinkGearData DataAt(double secondsFromBeginning){
      return new ThinkGearData(secondsFromBeginning,
                               ...
                               (int)ThinkGear.GetValue(0x26),
                               //70, // placeholder for zone meter
                               ThinkGear.GetValueStatus(ThinkGear.DATA_RAW) == 0 ? 200 : (int)ThinkGear.GetValue(ThinkGear.DATA_POOR_SIGNAL),
